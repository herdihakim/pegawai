(function($) {
	...
	$('.ubah-jam, .tambah-jam').live("click", function(){
            ...
            if(id != 0) {
		$("#myModalLabel").html("<img alt='Brand' src='logo/logo.png' style='width:50px; height:50px;'/>&nbsp;&nbsp;&nbsp;Ubah Data Jam Kerja");
            } else {
		$("#myModalLabel").html("<img alt='Brand' src='logo/logo.png' style='width:50px; height:50px;'/>&nbsp;&nbsp;&nbsp;Tambah Data Jam Kerja");
            }
	...
	$('.import').live("click", function(){
            ...
            $("#myModalLabel").html("<img alt='Brand' src='logo/logo.png' style='width:50px; height:50px;'/>&nbsp;&nbsp;&nbsp;Import Data Jam Kerja");
