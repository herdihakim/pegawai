(function($) {
	...
	$('.ubah-tunjangan, .tambah-tunjangan').live("click", function(){
            ...
            if(id != 0) {
		$("#myModalLabel").html("<img alt='Brand' src='logo/logo.png' style='width:50px; height:50px;'/>&nbsp;&nbsp;&nbsp;Ubah Data Tunjangan");
            } else {
		$("#myModalLabel").html("<img alt='Brand' src='logo/logo.png' style='width:50px; height:50px;'/>&nbsp;&nbsp;&nbsp;Tambah Data Tunjangan");
            }
	...
	$('.import').live("click", function(){
            ...
            $("#myModalLabel").html("<img alt='Brand' src='logo/logo.png' style='width:50px; height:50px;'/>&nbsp;&nbsp;&nbsp;Import Data Tunjangan");
