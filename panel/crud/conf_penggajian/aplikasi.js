(function($) {
	...
	$('.ubah-conf_penggajian, .tambah-conf_penggajian').live("click", function(){
		...
		$("#myModalLabel").html("<img alt='Brand' src='logo/logo.png' style='width:50px; height:50px;'/>&nbsp;&nbsp;&nbsp;Tambah Data conf_penggajian");
            }
	...
	$('.import').live("click", function(){
            ...
            $("#myModalLabel").html("<img alt='Brand' src='logo/logo.png' style='width:50px; height:50px;'/>&nbsp;&nbsp;&nbsp;Import Data conf_penggajian");
