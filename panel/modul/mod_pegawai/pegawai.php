...
<div class="panel panel-warning">
	...
	<div style="padding: 10px 10px 10px;">
            <a href="#dialog-pegawai" id="0" class="btn tambah-pegawai btn-info" data-toggle="modal" >Tambah Data</a> 
	</div>
        <div class="well">
            <div id="data-pegawai"></div>
	</div>
    </div>
</div>

<div class="modal fade" id="dialog-pegawai" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
