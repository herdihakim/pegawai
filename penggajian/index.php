...
<div id="cek"></div>
    ...
    <label for="exampleInputEmail1">Form Pengambilan Gaji Karyawan</label><hr/>
	...
	<button type="submit" class="btn btn-default">Submit</button>
	  ...
	  <th width="50%">
	 <div class="form-group">
    <label for="exampleInputEmail1">Tata Cara Penggajian</label><hr/>
    <ul>
	...
	<ul>
	<li>Untuk melakukan atau menyimpan data penggajian dengan mengklik tombol cetak </li>
	</ul>
	</div>
